...
class Math3ModelHandler:
    @staticmethod
    def predict_from_model(raw_df, model_path="math3_model.joblib", return_type="df"):
        ...
        if return_type == "df":
            return pd.DataFrame(predictions, columns=["Predicted Math-3 Theory"])
        return predictions
