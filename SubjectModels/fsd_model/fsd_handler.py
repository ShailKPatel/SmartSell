...
class FSDModelHandler:
    @staticmethod
    def predict_from_model(raw_df, model_path="fsd_model.joblib", return_type="df"):
        ...
        if return_type == "df":
            return pd.DataFrame(predictions, columns=["Predicted FSD Theory"])
        return predictions
